...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_recomended, R.id.nav_news, R.id.nav_concerts, R.id.nav_profile, R.id.nav_addArtist, R.id.nav_addConcert, R.id.nav_addNews, R.id.nav_map, R.id.nav_concertInfo, R.id.nav_newsInfo)
